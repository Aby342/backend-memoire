...
return [
    ...
    */
    ...
    | multiple sources which represent each model/table. These sources
    | may then be assigned to any extra authentication guards you have defined.
    |
    ...
    */
    ...
    'providers' => [
        ...
        // Exemple si tu voulais utiliser la table directement sans modèle
        // 'users' => [
        //     'driver' => 'database',
        //     'table' => 'users',
        // ],
